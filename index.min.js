...
b}var e,g,h=new d(function(a,b){e=a;g=b});this.callWhenSettled_(c(a,e),c(b,g));return h};d.prototype.catch=function(a){return this.then(void 0,a)};d.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case 1:a(d.result_);break;case 2:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?f.asyncExecute(c):this.onSettledCallbacks_.push(c)};d.resolve=c;d.reject=function(a){return new d(function(b,c){c(a)})};d.race=function(a){return new d(function(b,
...
var fs=require("fs"),path=require("path"),_compressor=require("node-minify"),DEFAULT_CALLBACK=function(a){return a&&console.log(a)},delay=function(a){a=void 0===a?100:a;return new Promise(function(b){setTimeout(function(){b()},a)})},asyncForEach=function(a,b,c){c=void 0===c?100:c;var e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){switch(d.nextAddress){case 1:e=0;case 2:if(!(e<a.length)){d.jumpTo(0);break}return d.yield(b(a[e]),5);case 5:return d.yield(delay(c),3);case 3:e++,d.jumpTo(2)}})},
walk=function(a,b){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){c=fs.readdirSync(a);return e.yield(asyncForEach(c,function(c){var d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:d=path.join(a,c);e=fs.statSync(d);if(!e.isFile()){f.jumpTo(2);break}return f.yield(b(d,e),3);case 3:return f.return(f.yieldResult);case 2:if(!e.isDirectory()||-1!==d.indexOf("node_modules")){f.jumpTo(0);break}return f.yield(walk(d,b),5);case 5:return f.return(f.yieldResult)}})}),
0)})},minifyAll=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?DEFAULT_CALLBACK:c;var e,d,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){return 1==h.nextAddress?(e=b,d=e.js_compressor,f=e.css_compressor,g=void 0===e.silent?!1:e.silent,h.yield(walk(a,function(a){return new Promise(function(b){var e=a.endsWith(".js")&&!a.endsWith(".min.js");if(a.endsWith(".css")&&!a.endsWith(".min.css")||e){var h=a.replace(e?".js":".css",e?".min.js":".min.css");g||console.log("Minifying "+a);_compressor.minify({compressor:e?
d:f,input:a,output:h,callback:function(a,d){c(a,d);b()}})}else b()})}),2)):h.return(h.yieldResult)})};
if(require.main===module){var args=(process.argv||[]).filter(function(a){return a.startsWith("--")}),input=(args.find(function(a){return a.startsWith("--input=")})||"").replace("--input=","")||__dirname,silent=1==(args.find(function(a){return a.startsWith("--silent=")})||"").replace("--silent=",""),js_compressor=(args.find(function(a){return a.startsWith("--js-compressor=")})||"").replace("--js-compressor=","")||"yui",css_compressor=(args.find(function(a){return a.startsWith("--css-compressor=")})||
"").replace("--css-compressor=","")||"yui";if(!input)throw Error("Input Path is required");minifyAll(input,{js_compressor:js_compressor,css_compressor:css_compressor,silent:silent}).then(function(){console.log("Minification finished")}).catch(function(a){console.error(a)})}else module.exports=minifyAll;